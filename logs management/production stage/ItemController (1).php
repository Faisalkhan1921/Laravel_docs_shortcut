        ...
        $auth = Auth::user()->id;
           ...
           if($auth_role_id == 1)
                        ...
                        'ipaddress' => $ipaddress,
                                'type' => 'general',
                                'section' => 'Product',
                                'description' => 'Product Added -> ' . json_encode($request->all()),
...
if($auth_role_id == 1)
            ...
            try {
                ...
                Log::channel('customer')->info('Item', [
                    ...
                    'type' => 'general',
                    'section' => 'Item',
                    'description' => 'Item deactivated -> ItemName = '. $cat_name,
                    'date' => now()->toDateString(),
                    'time' => now()->toTimeString(),
                ]);
            } catch (\Exception $e) {
...
if($auth_role_id == 1)
            ...
            try {
                ...
                Log::channel('customer')->info('Item', [
                    ...
                    'type' => 'general',
                    'section' => 'Item',
                    'description' => 'Item Activated -> ItemName = '. $cat_name,
                    'date' => now()->toDateString(),
                    'time' => now()->toTimeString(),
                ]);
            } catch (\Exception $e) {
